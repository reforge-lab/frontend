...
<Cards>
  <Card title="The Problem: MEV & Priority Gas Auctions" description="How the race to liquidate first creates massive gas waste and extracts excessive value from borrowers." href="/docs/getting-started/problem-statement" />
</Cards>
