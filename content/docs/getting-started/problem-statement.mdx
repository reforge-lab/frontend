...
<Cards>
  <Card title="1. Massive Economic Gas Waste" description="Liquidators surrender up to 70-90% of their gross margin in gas wars, directing capital away from DeFi utility and into validator pockets." />
  <Card title="2. Excessive Borrower Collateral Loss" description="Borrowers suffer fixed 5-10% penalties regardless of whether market conditions require such heavy discounts to achieve liquidity." />
  <Card title="3. Cascading DEX Price Crashes" description="Liquidators dump seized collateral rapidly on AMMs to lock in profits, causing localized slippage and triggering secondary liquidations." />
  <Card title="4. Consensus Instability" description="High MEV rewards create incentives for time-bandit attacks, transaction reordering, block reorganizations, and validator timing games." />
</Cards>
...
<Cards>
  <Card title="Literature Review" description="Examine 12 foundational academic papers analyzing DeFi liquidations, MEV, and order-fairness." href="/docs/getting-started/literature-review" />
  <Card title="Our Solution" description="How Reforge's MEV-Aware Batch Auction replaces PGAs with Net Economic Value scoring." href="/docs/getting-started/our-solution" />
</Cards>
