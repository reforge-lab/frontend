...
<Cards>
  <Card title="System Architecture" description="Explore the end-to-end architecture across contracts, backend, frontend, and simulation." href="/docs/architecture" />
  <Card title="Specifications" description="Review the technical specifications for each contract and backend service." href="/docs/specs" />
</Cards>
