...
<Cards>
  <Card
    ...
    description="Explore the end-to-end architecture across contracts, backend, frontend, and simulation."
    href="/docs/architecture"
  />
  <Card
    icon={<ScrollText />}
    title="Specifications"
    description="Review the technical specifications for each contract and backend service."
